...
public class RestaurantTest {
	...
	public void testRestaurantConstructor() {
		String jsonString = "{\"is_claimed\": true, \"rating\": 4.5, \"mobile_url\": \"http://m.yelp.com/biz/yam-leaf-bistro-mountain-view\","
				+ " \"rating_img_url\": \"http://s3-media2.fl.yelpcdn.com/assets/2/www/img/99493c12711e/ico/stars/v1/stars_4_half.png\","
				+ " \"review_count\": 204, \"name\": \"Yam Leaf Bistro\","
				...
				+ " \"phone\": \"6509409533\", \"snippet_text\": \"Phenomenal Pan-Latin vegetarian, vegan (any dish can be made vegan),"
				+ " and gluten-free dishes. There selection of organic wines and beers is incredible--I go...\","
				+ " \"image_url\": \"http://s3-media1.fl.yelpcdn.com/bphoto/6NchHRhvHpVj4DXs2WQATw/ms.jpg\","
				+ " \"location\": {\"city\": \"Mountain View\", \"display_address\": [\"699 Calderon Ave\", \"Mountain View, CA 94041\"],"
				+ " \"geo_accuracy\": 9.5, \"postal_code\": \"94041\", \"country_code\": \"US\", \"address\": [\"699 Calderon Ave\"],"
				+ " \"coordinate\": {\"latitude\": 37.3851249, \"longitude\": -122.075775}, \"state_code\": \"CA\"},"
				+ " \"display_phone\": \"+1-650-940-9533\","
				+ " \"rating_img_url_large\": \"http://s3-media4.fl.yelpcdn.com/assets/2/www/img/9f83790ff7f6/ico/stars/v1/stars_large_4_half.png\","
				+ " \"id\": \"yam-leaf-bistro-mountain-view\", \"is_closed\": false, \"distance\": 681.2472686205965}";
	...
	public void testStringToJSONArray() {
		try {
			...
			assertEquals(new JSONArray(), Restaurant.stringToJSONArray(new String(sb)));
			sb.append("Chinese");
			assertEquals(new JSONArray().put("Chinese"), Restaurant.stringToJSONArray(new String(sb)));
			sb.append(" Cantonese");
			assertEquals(new JSONArray().put("Chinese").put("Cantonese"), Restaurant.stringToJSONArray(new String(sb)));
			sb = new StringBuilder("French/Italian");
			assertEquals(new JSONArray("[French or Italian]"), Restaurant.stringToJSONArray(new String(sb)));
		} catch (JSONException e) {
